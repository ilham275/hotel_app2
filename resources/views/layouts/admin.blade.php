...
<!-- Sidebar -->
    <div class="sidebar">
      ...
      <nav class="mt-2">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <li class="nav-item">
                  <a href="{{route('indexa')}}" class="nav-link">
                    <i class="fas fa-home nav-icon"></i>
                    <p>kamar</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('ifasilitas')}}" class="nav-link">
                    <i class="fas fa-bed nav-icon"></i>
                    <p>Fasilitas</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('umfasilitas')}}" class="nav-link">
                    <i class="fas fa-home nav-icon"></i>
                    <p>Fasilitas Umum</p>
                </a>
            </li>
            ...
            {{-- <li class="nav-item">
                <a href="{{ route('admin.kamar') }}" class="nav-link">
                    <i class="fas fa-bed nav-icon"></i>
                    <p>Kamar</p>
                </a>
            </li>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{route('datares')}}" class="nav-link">
              <i class="fas fa-home nav-icon"></i>
      ...
      <li class="nav-item">
        <a href="{{route('cek')}}" class="nav-link">
            <i class="fas fa-home nav-icon"></i>
            <p>To Cek In</p>
        </a>
    </li>
      <li class="nav-item">
        <a href="{{route('tocekin')}}" class="nav-link">
            <i class="fas fa-home nav-icon"></i>
            <p>Data Cek In</p>
        </a>
    </li>
      <li class="nav-item">
        <a href="{{route('tocekout')}}" class="nav-link">
            <i class="fas fa-home nav-icon"></i>
            <p>Data Cek Out</p>
        </a>
    </li>
      ...
      <li class="nav-item">
        <a href="{{route('logall')}}" class="nav-link">
            <i class="fas fa-home nav-icon"></i>
            <p>All Log</p>
        </a>
    </li>
