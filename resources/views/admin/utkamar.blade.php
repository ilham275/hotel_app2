          ...
          <form method="POST" action="{{route('pkamar', $data->id)}}"  enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_kamar" name="nama_kamar" value="{{$data->nama_kamar}}">
              </div>
              <div class="form-group">
                <label for="type_kamar">Type Kamar</label>
                <input type="text" class="form-control" id="type_kamar" name="type_kamar" value="{{$data->type_kamar}}">
              </div>
              <div class="form-group">
                <label for="harga_kamar">Harga Kamar</label>
                <input type="text" class="form-control" id="harga_kamar" name="harga_kamar" value="{{$data->harga_kamar}}">
              </div>
              <div class="form-group">
